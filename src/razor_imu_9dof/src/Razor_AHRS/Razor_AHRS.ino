...
//accel x,y,z (min/max) = -308.00/225.00  -317.00/376.00  -309.00/431.00
float ACCEL_X_MIN = -308.00;
float ACCEL_X_MAX = 225.00;
float ACCEL_Y_MIN = -317.00;
float ACCEL_Y_MAX = 376.00;
float ACCEL_Z_MIN = -309.00;
float ACCEL_Z_MAX = 431.00;

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
//magn x,y,z (min/max) = -3378.00/775.00  -3098.00/1803.00  -4416.00/906.00
//magn x,y,z (min/max) = -3803.00/753.00  -3065.00/1622.00  -4426.00/1120.00

float MAGN_X_MIN = -3803.00;
float MAGN_X_MAX = 753.00;
float MAGN_Y_MIN = -3065.00;
float MAGN_Y_MAX = 1622.00;
float MAGN_Z_MIN = -4426.00;
float MAGN_Z_MAX = 1120.00;
...
//gyro x,y,z (current/average) = -7.00/-6.40  36.00/35.97  18.00/17.23

float GYRO_AVERAGE_OFFSET_X = -6.40;
float GYRO_AVERAGE_OFFSET_Y = 35.97;
float GYRO_AVERAGE_OFFSET_Z = 17.23;
